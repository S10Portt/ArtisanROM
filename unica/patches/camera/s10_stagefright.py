...
BEFORE = '5a701e4c73d866d5bffc7f0d90f8da52c3346ce591e9b84b22ba1946f2ca3950'
AFTER = '5aa9a4495322b3c534eb907b553e0816c6641f7f90f7b575bfb551bffeae9fac'
...
def apply(path):
    ...
    try:
        ...
        if os.path.lexists(name):
            os.unlink(name)
    print('S10 stagefright: applied GZD7 caller changes and bounded process-name read')
